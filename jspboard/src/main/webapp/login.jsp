...
<body>
	...
	<div class="container">
		<form method="post" action="./UserLoginServlet">
			<table class ="table table-bordered table-hover" style="text-aling: center; border: 1px solid #dddddd">
				<thead>
					<tr>
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" type="password" name="userPassword" maxlength="20" placeholder="비밀전호를 입력하세요."></td>
					</tr>	
					<tr>
