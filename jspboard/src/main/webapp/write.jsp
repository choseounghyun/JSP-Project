...
<body>
    ...
    <div class="container">
        <div class="row">
            <form method="post" action="writeAction.jsp" enctype="multipart/form-data"> <!-- enctype 추가 -->
                <table class="table table-bordered table-hover" style="text-align:enter; border : 1px solid #dddddd;">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2480"
                                    style="height:350px;"></textarea></td>
                        </tr>
                        <tr>
                            <td><input type="file" name="fileName"></td> <!-- 파일 업로드 input 추가 -->
                        </tr>
                    </tbody>
                </table>
