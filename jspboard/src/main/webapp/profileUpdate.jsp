...
<body>
	...
	<div class="container">
		<form  id="form" name="form" method="post" action="./UserProfileServlet" enctype="multipart/form-data" >
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="3"><h4>프로필</h4></th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						<td style="width: 110px;"><h5>내 이미지</h5></td>
						<td colspan="2">
							<img class="my-img" style="width: 300px; height: 400px;" src="<%= Profile %>" alt="">
						</td>
					</tr>
					<tr>
